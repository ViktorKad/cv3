...
jn.create('footer__item',
'<div class="footer__item">' +
'    [% content %]' +
'</div>');
jn.create('footer__tech',
'<div class="footer__tech">' +
'    <div class="footer__tech-name">[% name %]</div>' +
'    <div class="footer__tech-desc">[% desc %]</div>' +
'</div>');
jn.create('footer__about-me',
'<div class="footer__item">' +
'    [% lang:about_me.text1 %]' +
'</div>' +
'<div class="footer__item">' +
